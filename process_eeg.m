...
for i=1:num_mi_sessions
    session_data = MI_sessions{i}.Raw_Data;
    save("./EEGLAB_INPUT/EEG/EEG_DATA_"+num2str(curr_subject)+"_"+ ...
        MI_sessions{i}.Session+"_"+MI_sessions{i}.Online+"_"+MI_sessions{i}.Repetition+".mat","session_data");
end
%% 
